...
Todo jugador debe registrarse con su nombre o apodo único en la sección de Pronósticos.
No se permiten nombres duplicados.
Una vez registrado el jugador, su nombre aparecerá en la tabla general de Clasificación.
⚽ 2. Ingreso de Pronósticos

Cada participante debe ingresar su marcador pronosticado (Goles Equipo 1 y Goles Equipo 2) para cada partido.
Los cambios e ingresos de marcadores se auto-guardan instantáneamente en el navegador del organizador.
Fecha límite de ingreso: Los pronósticos deben quedar registrados y guardados antes de la hora oficial de inicio de cada partido. Una vez comenzado el encuentro, no se admitirán modificaciones.
...
Carlos predice 2 - 1 (Exacto 
→
 3 puntos, no participa en el consuelo).
Sofía predice 1 - 0 (Diferencia de 2 goles 
→
 Acierta ganador 
→
 1 punto).
Diego predice 2 - 0 (Diferencia de 1 gol 
→
 Acierta ganador 
→
 1 punto + Consuelo por cercanía 
→
 1 punto). Total de Diego: 2 puntos.
...
Excel General: Cualquier usuario puede descargar el reporte de Excel .xlsx que contiene:
...
Respaldo JSON: Aunque los datos se guardan de forma centralizada y segura en la base de datos del hosting cPanel, el administrador puede descargar un respaldo en formato JSON como medida de seguridad adicional o para migrar la información si es necesario.
